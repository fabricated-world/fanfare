...
const requiredMethods = ['new_voice','is_entree','add_entree','list_entree','rm_entree','is_creat_voice','get_creat_voice','rm_creat_voice',"all_creat_voice","add_template","get_randome_template","get_template"];
